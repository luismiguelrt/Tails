...
namespace Tails
{
    ...
    class Hardware
    {
        ...
        public static void DrawHiddenImageBackground(Image background, int x, int y, int height, int width)
        {
            ...
            Sdl.SDL_BlitSurface(background.GetPointer(), ref origin, hiddenScreen, ref dest);
        }
